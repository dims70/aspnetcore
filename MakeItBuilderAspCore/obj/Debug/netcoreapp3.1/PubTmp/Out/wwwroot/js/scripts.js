...
(function () {
  ...
  function countPlus() {
    ...
    let counter =
      this.parentNode.parentNode.parentNode.querySelector(".card__count");
  ...
  if (cardBtns)
    cardBtns.forEach(function (e) {
      e.addEventListener("click", activeCard);
    });

  if (cardBtnPlus)
    cardBtnPlus.forEach(function (e) {
      e.addEventListener("click", countPlus);
    });

  if (cardBtnMinus)
    cardBtnMinus.forEach(function (e) {
...
(function () {
  ...
  let basketBtnPlus = document.querySelectorAll(
    ".basket-products__item .basket-products__btn--plus"
  );
  let basketBtnMinus = document.querySelectorAll(
    ".basket-products__item .basket-products__btn--minus"
  );

  let basketBtnClear = document.querySelectorAll(
    ".basket-products__btn--clear"
  );
  ...
  async function deleteItem(e) {
    let delPost = await fetch("http://localhost:5000/api/basket/", {
      method: "POST",
      headers: {
  ...
  function countPlus() {
    let price = this.parentNode.parentNode.querySelector(
      ".basket-products__price span"
    );
    let x = price.dataset.price;
  ...
  if (basketBtnAdd)
    basketBtnAdd.forEach(function (e) {
      e.addEventListener("click", addItem);
    });

  if (basketBtnClear)
    basketBtnClear.forEach(function (e) {
      e.addEventListener("click", deleteItem);
    });

  if (basketBtnPlus)
    basketBtnPlus.forEach(function (e) {
      e.addEventListener("click", countPlus);
    });

  if (basketBtnMinus)
    basketBtnMinus.forEach(function (e) {
      e.addEventListener("click", countMinus);
    });
})();
...
(function () {
  ...
  function active() {
    ...
    if (this.classList.contains("form__btn--delivery")) {
      document
        .querySelector(".form__delivery-delivery")
    ...
    if (this.classList.contains("form__btn--pickup")) {
      ...
      document
        .querySelector(".form__delivery-pickup")
        .classList.remove("d-none");
    }
  }
...
(function () {
  ...
  menuBtn.onclick = function () {
    let body = this.querySelector(".mobile__menu-wrp");
    if (body.classList.contains("mobile__menu-wrp--disable")) {
      body.classList.remove("mobile__menu-wrp--disable");
      document.querySelector(".popup-basket__bg").classList.remove("d-none");
    } else {
      body.classList.add("mobile__menu-wrp--disable");
      document.querySelector(".popup-basket__bg").classList.add("d-none");
    }
  };
})();
